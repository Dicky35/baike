        ...
        <div class="basic-info">
          ...
          <el-form class="basic-info-form">
            ...
            <div class="basic-info-property">
              <div class="basic-info-property-header">
                ...
                <div style="float:right;margin-top:5px">
                  ...
                  <a
                    ...
                    @click="form.info_box.push({key:'',value:''})"
                  >
              ...
              <div>
                <template v-for="(item,index) in form.info_box">
                  <div :key="index" class="basic-info-property-item">
                    ...
                    <div style="float:left;margin-left:8px;line-height:40px;">
                      <a
                        ...
                        @click="form.info_box.splice(index,1)"
                      ></a>
                    </div>
                    <div class="clear"></div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    initData () {
      ...
      //         this.form.original_id = data.id
      //         this.form.name = data.name
      //         this.form.intro = data.intro
      //         this.form.imageUrl = data.imageUrl
      //         this.form.info_box.splice(0, this.form.info_box.length)
      //         for (var info of data.info_box) {
      //           this.form.info_box.push(info)
      //         }
      ...
      this.form = JSON.parse(window.sessionStorage.getItem('item'))

      console.log('编辑器人员Id: ', this.user_id)
      console.log('编辑器人员token: ', this.user_token)
      console.log('编辑器专题id: ', this.task_id)
      ...
      //   .then(res => {
      //     if (res.data.data) {
      //       this.form.original_id = res.data.data.original_id
      ...
      //       }
      //       for (var info of res.data.data.info_box) {
      //         this.form.info_box.push(info)
      //       }
        ...
        .then(res => {
          if (res.data) {
            ...
            for (var attribute of res.data.attributes) {
              this.form.info_box.push({key: attribute, value: ''})
            }
          }
        })
        .catch(error => {
    ...
    handleReference() {
      if (this.others.referenceForm.type == 1) {
        ...
        this.form.reference[this.others.referenceForm.aim].title = this.others.referenceForm.title
        this.form.reference[this.others.referenceForm.aim].author = this.others.referenceForm.author
        this.form.reference[this.others.referenceForm.aim].url = this.others.referenceForm.url
      }
