    ...
    <el-card class="preview-intro" id="preContent">
      <div class="preview-main-wrap">
        ...
        <div class="preview-entry-attribute">
          ...
          <dl class="preview-attribute-left">
            <div v-for="(prop, index) in form.info_box" :key="index">
              <div v-if="index % 2 == 0">
                <dt>{{ prop.key }}</dt>
      ...
      <div class="preview-side-wrap">
        ...
        <div class="preview-relation">
          ...
          <ul>
            <li v-for="item in form.relation" :key="item.entry">
              <div>
                <h4 style="margin-left: 60px">{{ item.entry }}</h4>
                <h4 style="margin-left: 88px">{{ item.type }}</h4>
              </div>
            </li>
          </ul>
        </div>
